...
public class PopularBancoService {
	...
	public void produtoCategoriaDemo() {
		...
		img1.setNomeImagem("Xbox One S 500 GB");
		...
		img2.setNomeImagem("Apple iPhone 11 64GB");
